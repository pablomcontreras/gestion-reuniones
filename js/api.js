...
export async function getModuleData() {
  ...
  // MIGRACION TEMPORAL: sembrar reuniones 1, 2 y 3 si history esta vacio
  if (!rolled.history || rolled.history.length === 0) {
    await seedHistoryMigration(rolled);
...
async function seedHistoryMigration(data) {
  const seed = [
    {
      id: "reunion-3", title: "Reunion N° 3", date: "Martes, 28 de abril de 2026", startTime: "18:00",
      attendees: [
        { memberId: "m1", mode: "Presencial" }, { memberId: "m2", mode: "Presencial" },
        { memberId: "m6", mode: "Presencial" }, { memberId: "m3", mode: "Presencial" },
        { memberId: "m-1777559188354", mode: "Presencial" }, { memberId: "m9", mode: "Remota" },
        { memberId: "m5", mode: "Remota" },
      ],
      quorum: "7 asistentes", status: "Archivada", motivo: "", changeLog: [],
      items: [
        {
          title: "Análisis Informe Comisión Económica", status: "Tratado",
          comments: "La comisión económica proporciono un informe detallado dando respuesta a las preguntas preparadas en la reunion anterior. Debate sobre posibles objetivos, y situacion actual.\n\nLink al documento enviado: https://drive.google.com/file/d/1yrKmp_v_hS5-DZ0Ayr01xGyguFLiO6U_/view?usp=share_link\n\nAnalisis preparado por Maxi para su consideración: https://docs.google.com/document/d/1Ttte8wRhjgcSwJjuXNJU-1_ceUP6JaaQ/edit?usp=share_link",
          resolution: "Se compartíó la situación económica. Se determino que es importante modificar el balance de ingresos de la escuela. Hoy casi el 90% de los ingresos dependen de los aportes mensuales de las familias. Se propuso enfocarnos en la comunidad: (1) preguntar qué podemos hacer por ellos para orientarlos al consumo consciente, (2) activar la comunidad mediante un evento tipo peña con función recaudadora y de difusión SEF/Diente de león.",
          actionables: [
            { memberId: "m1", description: "Preguntar el monto exacto de SAC para julio", done: true },
            { memberId: "m2", description: "Preparar un brief con los fundamentos y objetivos generales de la solicitud de informacion a la comunidad", done: false },
            { memberId: "m5", description: "Con el brief previo, contactar a Pablo, padre de tercer grado para que ejecute.", done: false },
            { memberId: "m4", description: "Prospectar fechas para la Peña, evento SEF con posibles artistas", done: false },
          ],
        },
        {
          title: "Tiendita Dandelion", status: "Tratado",
          comments: "Claudio necesita estar mejor informado del proyecto tienda de león. La Tiendita atraviesa una situación económica delicada por bajas ventas. Se propuso hacer sinergia: destinar una pequeña comisión sobre las ventas de Diente de Leon cuya logística pase por sus manos.",
          resolution: "Esteban propuso que antes de hacer una propuesta a Claudio, primero escuchemos su situación actual. El se habia comprometido a presentar un informe. Hay que hacer seguimiento.",
          actionables: [{ memberId: "m3", description: "Contactar a Claudio / Jose Brizzi pidiéndole el informe que le fuera solicitado anteriormente", done: false }],
        },
        {
          title: "Repartiendo roles en la Comisión y Proyectos", status: "Tratado",
          comments: "Revisemos en conjunto el Organigrama borrador para descubrir lugares vacantes que puedan ser ocupados por miembros activos/de apoyo y buscando simplificar las funciones compartidas entre los proyectos.",
          resolution: "Se trabajo sobre el organigrama y se va completando. Esteban ya trabajo su parte, Yuli se comprometió a chequear y completar la rama \"Tienda Diente de león\".",
          actionables: [{ memberId: "m9", description: "Revisar y editar la rama de Tienda Diente de León en el organigrama", done: true }],
        },
      ],
    },
    {
      id: "reunion-2", title: "Reunion N° 2", date: "Martes, 14 de abril de 2026", startTime: "18:45",
      attendees: [
        { memberId: "m1", mode: "Presencial" }, { memberId: "m3", mode: "Presencial" }, { memberId: "m9", mode: "Presencial" },
      ],
      quorum: "3 asistentes", status: "Cerrada", motivo: "", changeLog: [],
      items: [
        {
          title: "Apertura y seguimiento de acuerdos", status: "Tratado",
          comments: "A. Reunión con Comisión Económica: se retomó el acuerdo de la Reunión N° 1.\nB. Plataformas para gestión de actas: Maxi elaboró y envió a Inés un documento de especificación funcional para el módulo de reuniones en la wiki.\nC. Reunión virtual intermedia: se retomó la votación pendiente de la Reunión N° 1.",
          resolution: "A. Maxi contactará a la CE esta semana solicitando espacio en Reunión N° 3.\nB. Se espera evaluación de Inés. Mientras tanto el registro continúa en .docx.\nC. La reunión virtual se usará situacionalmente, sin frecuencia fija.",
          actionables: [
            { memberId: "m1", description: "Contactar a la Comisión Económica y solicitar espacio en Reunión N° 3 o informe previo", done: true },
            { memberId: "m8", description: "Evaluar viabilidad de integrar el módulo de reuniones en la wiki según brief enviado", done: true },
          ],
        },
        {
          title: "Tienda Diente de León: primera entrega con TiendaNube y validación QR", status: "Tratado",
          comments: "Principal desafío: cuello de botella por falta de señal en la zona de entrega. Yuliana relató su experiencia como coordinadora logística del 11 de abril. Propuestas: sistema asíncrono de validación; cartelaría de difusión (Camila del equipo SEF disponible).",
          resolution: "Inés evaluará la viabilidad técnica del sistema asíncrono de validación QR sin conexión. Queda pendiente definir responsable para la cartelaría.",
          actionables: [{ memberId: "m8", description: "Evaluar viabilidad técnica del sistema asíncrono de validación QR sin conexión para Tienda Diente de León", done: false }],
        },
        {
          title: "Organigrama de la Comisión", status: "Tratado",
          comments: "Se debatió la necesidad de una representación gráfica de los roles. Indispensable antes de convocar nuevas personas dado el crecimiento operativo.",
          resolution: "Maxi elaborará un primer borrador del organigrama para presentar en la Reunión N° 3.",
          actionables: [{ memberId: "m1", description: "Elaborar primer borrador del organigrama de la comisión (roles y relaciones) para presentar en Reunión N° 3", done: true }],
        },
        {
          title: "Encuadre legal e impositivo del Marketplace", status: "Postergado",
          comments: "No fue tratado. Los fundamentos ya están documentados. Se postergó por escaso tiempo y reducido número de asistentes.",
          resolution: "Se incorpora al orden del día de la Reunión N° 3 como prioridad.",
          actionables: [],
        },
        {
          title: "Participación de miembros no presenciales", status: "Tratado",
          comments: "Se debatió el mecanismo para integrar a integrantes que no pueden asistir los martes. Inicio efectivo de agenda: 18:45, luego del espacio de lectura.",
          resolution: "Se habilita la participación remota por videollamada a demanda. Solo podrán proponer puntos quienes puedan asistir —presencial o remotamente— a esa reunión.",
          actionables: [],
        },
        {
          title: "SEF: activación comunitaria", status: "Tratado",
          comments: "Esteban planteó que el principal desafío de SEF es la activación de la comunidad, que en gran parte desconoce SEF y la Tienda Diente de León. Propuestas: evento de activación; comunicación institucional formal.",
          resolution: "Se decide avanzar con una comunicación formal a la comunidad sobre SEF y Tienda Diente de León. Queda pendiente responsable y canal. Evento de activación: pendiente responsable y fecha.",
          actionables: [],
        },
      ],
    },
    {
      id: "reunion-1", title: "Reunion N° 1", date: "Martes, 7 de abril de 2026", startTime: "18:00",
      attendees: [
        { memberId: "m1", mode: "Presencial" }, { memberId: "m4", mode: "Presencial" },
        { memberId: "m5", mode: "Presencial" }, { memberId: "m6", mode: "Presencial" },
        { memberId: "m7", mode: "Presencial" }, { memberId: "m2", mode: "Presencial" },
      ],
      quorum: "6 asistentes", status: "Cerrada", motivo: "", changeLog: [],
      items: [
        {
          title: "Apertura y formato de trabajo", status: "Tratado",
          comments: "Maxi presentó la propuesta de sistematizar el orden del día y llevar actas de reunión. Ana planteó quiénes podrían proponer puntos. Sebastián sugirió investigar plataformas existentes para el seguimiento de actas.",
          resolution: "Acuerdo: cualquier miembro que no pueda asistir debe canalizar su propuesta a través de un asistente presencial. La iniciativa es aprobada por unanimidad.",
          actionables: [{ memberId: "m2", description: "Investigar plataformas existentes para seguimiento de actas y orden del día, y presentar opciones en la próxima reunión", done: false }],
        },
        {
          title: "Informe reunión intercomisiones", status: "Tratado",
          comments: "Maxi realizó una síntesis de lo presentado: propuesta de consolidación de proyectos, Marketplace y encuadre legal. El equipo manifestó la necesidad de contar con datos económicos precisos de la escuela.",
          resolution: "Invitar a la Comisión Económica a remitir un informe con déficit, ingresos y egresos, o a una reunión conjunta.",
          actionables: [{ memberId: "m1", description: "Gestionar contacto con Comisión Económica para solicitar informe de números actuales o reunión conjunta", done: true }],
        },
        {
          title: "Diente de León — Estado del piloto", status: "Postergado",
          comments: "Al no estar presente ningún miembro con intervención directa en la infraestructura del proyecto, el debate resultó vacío de contenido.",
          resolution: "Postergado por unanimidad hasta la próxima reunión.",
          actionables: [],
        },
        {
          title: "Presentación de proveedor: Alfajores El Nazareno", status: "Tratado",
          comments: "Maxi presentó los aspectos prácticos de la incorporación de productos de El Nazareno a la tiendita. Franco Alini trajo la propuesta por conocer al proveedor de una experiencia previa.",
          resolution: "La gestión queda a cargo de María (responsable de proveedores en el proyecto yerba) junto a Franco Alini.",
          actionables: [],
        },
        {
          title: "SEF — Integración o rediseño", status: "Tratado",
          comments: "Javier realizó una síntesis del proyecto SEF. Considera difícil una fusión con la tienda, pero sí factible que convivan como proyectos hermanos. Debilidades: falta de comunicación, falta de agilidad tecnológica, baja conciencia de consumo. Propuestas: Delegado SEF por grado; análisis tecnológico a Inés; fondos SEF para pago de aportes.",
          resolution: "SEF y Tienda convivirán como proyectos hermanos. Se delega a Inés el análisis tecnológico. La figura de Delegado SEF se definirá post-modernización.",
          actionables: [
            { memberId: "m8", description: "Analizar alternativas tecnológicas para modernizar y agilizar la plataforma SEF", done: false },
            { memberId: "m7", description: "Definir cómo articular la figura de Delegado SEF por grado: perfil, mensaje y momento de lanzamiento", done: false },
            { memberId: "m7", description: "Evaluar la viabilidad de implementar la funcionalidad de destinar fondos SEF al pago de aportes mensuales", done: false },
          ],
        },
        {
          title: "Encuadre legal e impositivo del Marketplace", status: "Postergado",
          comments: "El tiempo disponible se agotó al concluir el Punto 4.", resolution: "Postergado para la siguiente reunión.", actionables: [],
        },
        {
          title: "Participación de miembros no presenciales", status: "Postergado",
          comments: "El tiempo disponible se agotó al concluir el Punto 4.", resolution: "Postergado para la siguiente reunión.", actionables: [],
        },
      ],
    },
  ...
  const token = await getAuthToken();
  const url = `${moduleConfig.apiBaseUrl}/history.json?auth=${token}`;
  await fetch(url, {
    method: "PUT",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(seed),
  });
  console.log("[migration] history sembrado con 3 reuniones");
}
